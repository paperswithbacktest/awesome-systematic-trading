...
| [FinClaw](https://github.com/NeuZhou/finclaw) | AI-powered financial intelligence engine with 8 master trading strategies (momentum, mean reversion, sentiment, factor, technical, fundamental, event-driven, risk parity) and multi-agent architecture. Supports US, CN, HK markets. +29.1% annual alpha. | ![GitHub stars](https://badgen.net/github/stars/NeuZhou/finclaw) | ![made-with-javascript](https://img.shields.io/badge/Made%20with-JavaScript-1f425f.svg) |

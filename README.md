...
| [CoinPaprika Python SDK](https://github.com/coinpaprika/coinpaprika-api-python-client) | Free crypto market data API client. 12,000+ coins, 350+ exchanges, tickers, OHLCV, historical prices. No API key for free tier. | ![GitHub stars](https://badgen.net/github/stars/coinpaprika/coinpaprika-api-python-client) | ![made-with-python](https://img.shields.io/badge/Made%20with-Python-1f425f.svg) |
| [DexPaprika Python SDK](https://github.com/coinpaprika/dexpaprika-sdk-python) | Free DEX data API client. 34 chains, 30M+ pools, 27M+ tokens, real-time SSE streaming, OHLCV. No API key needed. | ![GitHub stars](https://badgen.net/github/stars/coinpaprika/dexpaprika-sdk-python) | ![made-with-python](https://img.shields.io/badge/Made%20with-Python-1f425f.svg) |

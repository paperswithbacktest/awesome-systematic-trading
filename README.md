...
| [Chart Library](https://github.com/grahammccain/chart-library-mcp) | Historical chart pattern similarity search engine. 24M+ pre-computed embeddings across 15K+ symbols, 10 years of data. Returns forward returns for pattern-based strategy development. | ![GitHub stars](https://badgen.net/github/stars/grahammccain/chart-library-mcp) | ![made-with-python](https://img.shields.io/badge/Made%20with-Python-1f425f.svg) |

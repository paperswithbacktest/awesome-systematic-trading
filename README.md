...
| [quantwave](https://github.com/lavs9/quantwave) | Polars-native TA and backtesting with bit-identical batch/streaming parity and an agent skill for research-to-live consistency | ![GitHub stars](https://badgen.net/github/stars/lavs9/quantwave) | ![made-with-python](https://img.shields.io/badge/Made%20with-Python-1f425f.svg) |

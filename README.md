...
| [investment_data](https://github.com/xu-duqing/investment_data) | Automatically updated China A-share market data, adjustment factors, trading calendars, index constituents, and fundamental indicators in Qlib format. | ![GitHub stars](https://badgen.net/github/stars/xu-duqing/investment_data) | ![made-with-python](https://img.shields.io/badge/Made%20with-Python-1f425f.svg) |
